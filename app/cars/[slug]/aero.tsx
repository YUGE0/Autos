...
}) 
{
  return (
    <div className="mt-5">
      ...
      {aerodynamics.aeropt!==null && <div className="flex flex-wrap lg:flex-nowrap justify-between items-center pt-10">
        <h1 className="py-10 px-0 lg:px-10 lg:py-0">{aerodynamics.aeropt}</h1>
        <Image className="rounded-xl shadow-lg shadow-black" width={500} height={300} alt="Aero" style={{height: 'auto', width:'auto'}} src={aerodynamics.aeroimgt}/>
      </div>}
    </div>
  )
}
